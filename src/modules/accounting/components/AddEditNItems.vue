<template>
  <q-layout style="width: 550px !important;">
    ...
    <q-card-section class="q-gutter-md scroll">
      ...
      <q-input outlined v-model="nonInventoryItem.unitPrice" label="Unit price" type="number" />
      <q-input outlined v-model="nonInventoryItem.supplier" label="Supplier" />
      <q-editor             
        v-model="nonInventoryItem.description" :dense="true" :toolbar="[
          [
            {
