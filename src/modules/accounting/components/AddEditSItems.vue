  ...
  <q-layout style="width: 550px !important;">
    <q-card style="max-width: 550px; height:100vh;" flat square>
      ...
      <q-card-section class="q-gutter-md scroll">
        ...
        <q-input outlined v-model="serviceItem.unitPrice" label="Unit price" type="number" />
        <q-input outlined v-model="serviceItem.supplier" label="Supplier" />

        <q-editor
          v-model="serviceItem.description" :dense="true" :toolbar="[
            [
              {
