...
//         <modal @closeDialogue="getPost(); dialogue = false" actionType="Edit" :body="post" />
//       </q-dialog>
//     </div>
//   </q-toolbar>
// </q-layout>
...
//     ...mapActions('socialMediaManagementStore',['updatePost','getOnePost']),
//     dateConversion(d) {
...
//     },
//     async getPost() {
//       await getOnePost(this.$route.params.id);
