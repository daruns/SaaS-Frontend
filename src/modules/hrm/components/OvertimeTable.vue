<template>
  <div>
    <h6 class="q-pa-md">All Employees Overtimes</h6>
    <q-table
      :rows="data"
      :columns="columns"
...
export default {
  computed: {
    ...mapState('hrmStore', ['overtimes']),
    data(){
      let finalres = JSON.parse(JSON.stringify(this.overtimes)).sort((a,b) => b['id'] - a['id'])
      ...
      console.log("overtimes: ",finalresParsed)
  ...
  methods: {
    ...mapActions('hrmStore',['getOvertimes','deleteOvertime']),
