<template>
  <q-page class="q-py-none q-my-none">
    <div class="full-width flex justify-between items-center header-height-standard q-px-md" style="border-bottom: 1px solid lightgrey;">
      <div class="text-h4">Overtime Types</div>
...
<script>
import table from '../components/OvertimeTypeTable.vue';
import { ref } from 'vue';
import AddEditOvertimeType from '../components/AddEditOvertimeType.vue'
