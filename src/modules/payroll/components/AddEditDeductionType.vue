...
export default {
 ...
 props: ['actionType','body'],
  ...
  methods: {
    ...
    ...mapActions('payrollStore', ['createDeductionType', 'updateDeductionType']),
   async submit() {
      ...
      if (
        ...
        try {
          ...
          if(this.actionType === 'Add'){
            ...
            await this.createDeductionType(data)
            this.$q.notify({
              type: 'positive',
            ...
            await this.updateDeductionType(data);
            this.$q.notify({
              type: 'positive',
