            ...
            <q-btn dense round flat icon="more_vert">
              ...
              >
                <q-list style="min-width: 75px">
                  <q-item @click="deleteEarningType({id: props.row.id})" style="padding 0 !important" clickable v-close-popup>
                    <q-item-section class="flex flex-center"><q-icon name="delete" color="negative" size="xs"></q-icon></q-item-section>
                  </q-item>
                  <q-separator />
                  <q-item @click="editEarningType(props.row)" clickable v-close-popup>
