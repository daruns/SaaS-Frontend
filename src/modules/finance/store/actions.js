...
export async function getChildSubCategories({commit}) {
  let response = await axios.get(process.env.OC_BACKEND_API + 'expenseChildSubCategories', {headers: {Authorization: localStorage.getItem('accessToken')}});
  await commit('GET_CHILD_SUB_CATEGORIES' ,response.data.data);
}

export async function addChildSubCategory({dispatch}, payload) {
  let response = await axios.post(process.env.OC_BACKEND_API + 'expenseChildSubCategories/create', payload, {headers: {Authorization: localStorage.getItem('accessToken')}});
  await dispatch('getCategories');
}

export async function editChildSubCategory({dispatch}, payload) {
  let response = await axios.post(process.env.OC_BACKEND_API + 'expenseChildSubCategories/update', payload, {headers: {Authorization: localStorage.getItem('accessToken')}});
  await dispatch('getCategories')
}

export async function deleteChildSubCategory({dispatch}, payload) {
  let response = await axios.post(process.env.OC_BACKEND_API + 'expenseChildSubCategories/delete', payload, {headers: {Authorization: localStorage.getItem('accessToken')}});
  await dispatch('getCategories')
}
...
export async function getCurrencyCodes({commit}) {
  let response = await axios.get(process.env.OC_BACKEND_API + `currencyCodes`, {headers: {Authorization: localStorage.getItem('accessToken')}});
  await commit('GET_CURRENCY_CODES', response.data.data)
}